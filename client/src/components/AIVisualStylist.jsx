...
const STYLES = [
  { id: 'nordic', name: 'Estilo Nórdico', desc: 'Roble + Blanco Mate', colors: { main: '#ffffff', secondary: '#C8A96E' } },
  { id: 'industrial', name: 'Industrial', desc: 'Grafito + Metal', colors: { main: '#333333', secondary: '#111111' } },
  { id: 'minimalist', name: 'Minimalista', desc: 'Gris Cálido + Madera Oscura', colors: { main: '#e5e5e5', secondary: '#5D4037' } }
];
  ...
  return (
    <div className="absolute top-4 left-4 z-40">
      ...
      >
        ...
        <span className="text-sm font-medium tracking-wide">AI Visual Stylist</span>
      </button>
      ...
      {isOpen && (
        <div className="mt-2 w-72 bg-surface-1/90 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl p-4 animate-fade-in">
          <div className="flex items-center gap-2 mb-4 text-white">
            <Palette size={16} />
            <h3 className="text-sm font-bold">Sugerencias de Diseño</h3>
          </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted mt-0.5">{style.desc}</div>
                  </div>
                </div>
              </button>
            ))}
