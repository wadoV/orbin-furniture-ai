/**
 * Orbin AI ÔÇö Parametric Furniture Engine v2
...
// ÔöÇÔöÇÔöÇ Main Engine ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
function generateFurniture(params) {
  ...
  // 4. Internal Dividers (Lateral Interno) ÔÇö user-defined, auto-adds 1 if width > 900 and none specified
  ...
  if (cfg.hasCountertop) {
    pieces.push(makePiece(nextId('PIEDRA'), 'Encimera', 'countertop', W + 40, D + 20, 30, 1, 'horizontal', {}, 'M├írmol o Granito'))
  }

  // 5. Rodapie (Improved with front/back logic)
  if (BH3 > 0) {
    pieces.push(makePiece(nextId('RDPE-F'), 'Z├│calo Frontal', 'baseboard', internalWidth, BH3, T, 1, 'horizontal'))
    pieces.push(makePiece(nextId('RDPE-B'), 'Refuerzo Trasero Rodapi├®', 'baseboard', internalWidth, BH3, T, 1, 'horizontal'))
  }

  // 6. Drawers ÔÇö frontType: 'drawer_front' (altura configurable v├¡a drawerHeight)
  ...
  for (let i = 0; i < numDrawers; i++) {
    // Category A: Drawer Front ÔÇö perimetral gap 2mm/side ÔåÆ -4mm W and H
  ...
  // 7. Shelves ÔÇö qty = sections (one per span between dividers)
  ...
  if (hasDoors) {
    ...
    if (doorH > 100) {
      // Door: hinge overlay clearance ÔÇö 2.5mm per side (5mm total W), 4mm H for hinge cup
...
// ÔöÇÔöÇÔöÇ Cut List ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
// ÔöÇÔöÇÔöÇ Nesting Estimator ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
// ÔöÇÔöÇÔöÇ Hardware BOM ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
// ÔöÇÔöÇÔöÇ Main Entry Point ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
